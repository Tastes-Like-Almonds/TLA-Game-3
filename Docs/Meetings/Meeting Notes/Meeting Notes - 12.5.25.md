...
## Topics to Cover
___
- Cover deadlines for first area outline
- Start on future art for the first area
- What level selection system will we use? The one in [[Class Structure Overview.canvas|Class Structure Overview]], just a list? Maybe something like an in-game selector (Basically just one "hub" level)?
- Cover GitHub details with the other team
- Brief new team member on details of the project

## Notes
___
- Not much can be done until finals are over. I'll be more productive next week.
